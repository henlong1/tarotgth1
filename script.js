document.addEventListener('DOMContentLoaded', () => {
    ...
    const fullTarotDeck = [
        ...
        { name: '완드 시종 (Page of Wands)', keywords: '열정적인 소식, 새로운 아이디어, 모험심', interpretation: '열정적이고 흥미로운 소식이 당신에게 도착할 것입니다. 새로운 아이디어거나 기회가 찾아오니, 호기심을 가지고 모험을 시작하세요.' },
        ...
        // 마이너 아르카나 - 검 (Swords)
        { name: '검 에이스 (Ace of Swords)', keywords: '새로운 진실, 명확성, 돌파구, 지성', interpretation: '명확한 진실이 드러나고 상황을 이해하게 됩니다. 새로운 아이디어거나 해결책이 떠오르며, 어려운 문제를 해결할 돌파구가 열립니다. 지성을 활용하여 결정을 내리세요.' },
